...
Incorporating area-level auxiliary data to the model increased its performance. The additional information obtained through two area-level covariates allowed us to produce *better-informed guesses* of our target variable.
