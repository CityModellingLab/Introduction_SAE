...
![<span style="font-size:80%;">Source: World Bank.</span>](Figures/WB_poverty_map.png){fig-align="center" width="4000"}

## SAE in the wild

![<span style="font-size:65%;">Source: Bennett, J. E., Rashid, T., Zolfaghari, A., Doyle, Y., Suel, E., Pearson-Stuttard, J.,  & Ezzati, M. (2023). Changes in life expectancy and house prices in London from 2002 to 2019. *The Lancet Regional Health–Europe*, 27.</span>](Figures/housing-prices.jpg){fig-align="center" width="4000"}
...
::: { .incremental .fragment style="font-size: 80%;"}
